...
export class UserDetailsComponent {
  ...
  constructor(private readonly userService: UserService, public readonly congfi: LaGotitaConfigService) {}

  updateUser(user: any): void {
    const currentPersona = this.user();
